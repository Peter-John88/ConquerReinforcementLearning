...
![img](https://morvanzhou.github.io/static/results/ML-intro/s1.png)
...
![img](https://morvanzhou.github.io/static/results/ML-intro/s2.png)

Sarsa 的决策部分和 Q learning 一模一样, 因为我们使用的是 Q 表的形式决策, 所以我们会在 Q 表中挑选值较大的动作值施加在环境中来换取奖惩. 但是不同的地方在于 Sarsa 的更新方式是不一样的.

# Sarsa 更新行为准则 

![img](https://morvanzhou.github.io/static/results/ML-intro/s3.png)
...
![img](https://morvanzhou.github.io/static/results/ML-intro/s4.png)
...
![img](https://morvanzhou.github.io/static/results/ML-intro/s5.png)
